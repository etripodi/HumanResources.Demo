...
namespace Nacho.JuanAlvarez.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update JuanAlvarezDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update JuanAlvarezEfCoreEntityExtensionMappings to extend the IdentityUser entity
